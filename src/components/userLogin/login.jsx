...
const LoginUser = ({ isLogin, setIsLogin }) => {
      ...
      <View className="flex-1 justify-between p-2">
        <View className="gap-3 items-center">
          ...
          <View className="text-center">
            <TouchableOpacity activeOpacity={0.8} className="items-center" onPress={ForgotPassword}>
              <Text className="text-blue-800 text-base">Forgot password?</Text>
            </TouchableOpacity>
        ...
        <ButtonComp title="Sign Up" onPress={loginSubmit} />
      </View>
    </KeyboardAvoidingView>
  );
};
